...
class Migration(DataMigration):
    ...
    def backwards(self, orm):
        # Before reversing schema migration
        # 0005_increase_max_length_of_code_code_and_name_name.py, values in 
        # Code.code and Name.name which are longer than 10 and 100 characters
        # respectively will need to be shortened using a data migration. We can't
        # predict how that should best be done, so this data migration is empty
        # in both directions so that developers can write their own backwards
        # migration if/when necessary.
        pass
