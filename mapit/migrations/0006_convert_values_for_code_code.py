...
class Migration(DataMigration):
    ...
    def backwards(self, orm):
        "Write your backwards methods here."
         # Before reversing schema migration 0005_increase_max_length_of_code_code.py,
         # values in Code.code which are longer than 10 and characters will
         # need to be shortened using a data migration. We can't predict how
         # that should best be done, so this data migration is empty in both
         # directions so that developers can write their own backwards
