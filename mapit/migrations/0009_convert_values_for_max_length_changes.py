...
class Migration(DataMigration):
    ...
    def backwards(self, orm):
        # Before reversing migration 0008, any codes, names or descriptions
        # which are longer than the earlier value of max_length for their fields
        # will need to be shortened. Simply truncating values might attempt to
        # create duplicate values in fields with unique=True, so write your own
        # methods here to shorten them appropriately.
        pass
