...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('mapit_code', 'code', self.gf('django.db.models.fields.CharField')(max_length=40))

        # Changing field 'Name.name'
        db.alter_column('mapit_name', 'name', self.gf('django.db.models.fields.CharField')(max_length=150))
